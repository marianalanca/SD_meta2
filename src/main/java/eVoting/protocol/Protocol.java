...
public class Protocol implements Serializable {
	 ...
	 * @return String containing the eVoting.protocol with all the data received as param
	 */
	 ...
	 * @return String containing the eVoting.protocol message with all the data received as param
	 */
	 ...
	 * @param item_name contains the list to be passed in the eVoting.protocol
